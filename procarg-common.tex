...
\begin{procarg}{--delimiter=CHARACTER}
  Defines a delimiter character to separate coordinates of a point in the resulting output. A usual \codef{CHARACTER} could be a whitespace (\codef{' '}) or tabular character (\codef{'\chartab'}), for instance.
\end{procarg}}
